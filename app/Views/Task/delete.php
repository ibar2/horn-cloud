...
<?php else: ?>
    ...
    <div  style="width: 18rem;" class=" card h-100 d-flex align-items-center justify-content-center">
  <div class="card-body">
    <h5 class="card-title">Are you sure you want to Delete this?</h5>
    <p class="card-text"><?= $task['descripsion'] ?></p>
    <a href="/task/yes/<?= $task['id'] ?>" class="card-link">Yes</a>
    <a href="/task" class="card-link">Cancel</a>
  </div>
</div>
